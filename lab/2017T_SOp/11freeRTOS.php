...
<title>Zajęcia labaratoryjne nr 5 z przedmiotu Systemy Operacyjne System FreeRtos i korutyny</title>
</head>
<body>
...
<p>
Pobierz projekt z repozytorium. W tym celu utwórz (najlepiej za pomocą konsoli) katalog, w którym będzie przechowywany projekt, np tmp. Nastepnie przejdź do tego kotalogu i wpisz:
<pre>
...
<p>
Rozważ algorytm progamu, działa w następujący sposób.
<ol>
 ...
 <li>Istnieje korutyna, która sprawdza stan klawisz i jeśli klawisz jest wciśnięty, to wysyła wiadomość do odpowiedniego bufora, by zapalić na określony czas diodę. Korutyna ta zostanie utworzona w zadaniu 5.</li>
</p>
...
void vACoRoutine( xCoRoutineHandle xHandle, unsigned portBASE_TYPE uxIndex )
{
  ...
  // Ze zmiennych na stosie możemy korzystać pod warunkiem, że przz ten czas nie wykonamy makra, 
...
portSHORT main( void )
{
 ...
 static void prvCoRoutineFlashTask( xCoRoutineHandle xHandle, unsigned portBASE_TYPE uxIndex )
 {
  ...
  for( ;; )
  {
    ...
    // Wcześneij kolejka musi zostać utworzona, np w funkcji main
